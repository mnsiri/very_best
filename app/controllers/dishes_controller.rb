class DishesController < ApplicationController
  def index
    ...
    @dishes = @q.result(:distinct => true).includes(:bookmarks, :type_of_food, :specialists, :fans).page(params[:page]).per(10)
  ...
  def create
    ...
    @dish.type_of_cuisine_id = params[:type_of_cuisine_id]
